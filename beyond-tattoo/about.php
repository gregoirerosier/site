...
<main class="bt-storefront bt-library-page" id="top">
  ...
  <header class="bt-site-header"><div class="bt-wrap bt-site-header-inner">
    ...
    <nav class="bt-desktop-nav"><a href="index.php">Home</a><a href="stencils.php" >Stencils</a><a href="collections.php" >Collections</a><a href="about.php" class="is-active">About</a></nav>
