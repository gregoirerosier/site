...
(function initRotatingNowPlaying(){
  ...
  async function createPlayer(channel){
    ...
    if(isYoutube){
      ...
      player.innerHTML=`<video class="beyond-video" controls playsinline autoplay muted preload="metadata" poster="/assets/img/beyond-tv-promo.webp"></video>
